...
const TableBalAdjustDailyImbalance = forwardRef<any, TableProps>(({ openEditForm, openViewForm, openHistoryForm, openDeleteForm, openReasonModal, tableData, isLoading, columnVisibility, userPermission, zoneMaster, dataShipper, initialColumns, closeBalanceData, onSort }, ref) => {
    // const TableBalAdjustDailyImbalance: React.FC<TableProps> = ({ openEditForm, openViewForm, openHistoryForm, openDeleteForm, openReasonModal, tableData, isLoading, columnVisibility, userPermission, zoneMaster, dataShipper, initialColumns, closeBalanceData, onSort }) => {
