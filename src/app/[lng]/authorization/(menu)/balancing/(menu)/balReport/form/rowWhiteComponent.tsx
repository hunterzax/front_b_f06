...
export const ContractRowWhite = ({
  ...
  const getFormattedValueByTag = (tag: string) => {
    ...
    return item !== null && item !== undefined ? formatNumberFourDecimalNom(item.value) : '';
  };
  ...
  const getFormattedAbsValueByTag = (tag: string) => {
    ...
    return item !== null && item !== undefined ? formatNumberFourDecimalNom(Math.abs(item.value)) : '';
  };
        ...
        <>
          ...
          {columnVisibility.others_east && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              ...
              {(sumDetail(contract?.values, 'detail_entry_east_', ['gsp', 'bypassGas', 'lng', 'F2andG']))}
            </td>
          )}
          ...
          {columnVisibility.others_west && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {`no_data`} */}
              {(sumDetail(contract?.values, 'detail_entry_west_', ['yadana', 'yetagun', 'zawtika', 'F2andG']))}
            </td>
          )}
          ...
          {columnVisibility.others_east_exit && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {`no_data`} */}
              {/* {formatNumberFourDecimal(sumDetail(contract?.values, 'detail_exit_east_', ['egat', 'ipp', 'F2andG']))} */}
              {(sumDetail(contract?.["values"], "detail_exit_east_", [
                "egat",
                "ipp",
                "F2andG",
              ]) ?? "")}
          ...
          {columnVisibility.others_west_exit && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {`no_data`} */}
              {(sumDetail(contract?.values, 'detail_exit_west_', ['egat', 'ipp', 'F2andG']))}
            </td>
          )}
          ...
          {columnVisibility.others_east_west_exit && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {`no_data`} */}
              {(sumDetail(contract?.values, 'detail_exit_east-west_', ['egat', 'ipp', 'F2andG']))}
            </td>
          )}
