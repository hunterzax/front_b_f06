                                ...
                                <tr className="h-9">
                                    ...
                                    {columnVisibility.timestamp && (
                                        <th
                                            ...
                                            rowSpan={4} scope="col"
                                        // onClick={() => beforeSort("execute_timestamp", sortState, setSortState, setSortedData, tableData)}
                                              onClick={() => beforeSort( 
                                    ...
                                    {columnVisibility.detail_pane && (
                                        <>
                                            ...
                                            {columnVisibility.exit && (
                                                <th
                                                    className={`${table_header_style} text-center bg-[#3A8FB8]`} rowSpan={1} scope="col"
                                                    // colSpan={13}
                                ...
                                <tr className="h-9">
                                    {columnVisibility.detail_pane && (
                                        <>
                                            ...
                                            {/* E5EED9  DBE1F2 */}
                                            {/* DBE4FF  FFCEE2 */}
                                            {/* https://app.clickup.com/t/9018502823/86eujrg5h */}
