...
import { formatNumberFourDecimal, formatNumberSixDecimal, formatNumberSixDecimalNom, formatNumberTwoDecimal, formatNumberTwoDecimalNom } from "@/utils/generalFormatter";
                        ...
                        <thead className="text-xs text-[#ffffff] bg-[#1473A1] sticky top-0 z-10">
                            <tr className="h-10">
                                ...
                                {columnVisibility.acc_imbalance_inventory_mmbtu && (
                                    <th
                                        className={`${table_header_style} text-center min-w-[120px] w-[200px] max-w-[350px] border-r border-gray-400`} rowSpan={1} colSpan={getVisibleChildCount("acc_imbalance_inventory_mmbtu")} scope="col"
                                    >
                                ...
                                {columnVisibility.condition_east && (
                                    <th
                                        ...
                                        onClick={() => handleSortIntradayDashboard(
                                            "actual_.condition_east.value", sortState, setSortState, setSortedData, tableData
                                        )} // actual_ https://app.clickup.com/t/86eujrgb3
                                    >
                                        <div>{`Condition`}</div>
                                        <div>{`East`}</div>
                                ...
                                {columnVisibility.condition_west && (
                                    <th
                                        className={`${table_sort_header_style} text-center min-w-[120px] w-[130px] max-w-[150px] border-r border-gray-400`} rowSpan={2} scope="col"
                                        onClick={() => handleSortIntradayDashboard(
                                            "actual_.condition_west.value", sortState, setSortState, setSortedData, tableData
                                        )} // actual_ https://app.clickup.com/t/86eujrgb3
                                    >
                                        <div>{`Condition`}</div>
                                        <div>{`West`}</div>
                                ...
                                {columnVisibility.entry_mmbtu && (<>
                                    {columnVisibility.east_total_entry_mmbtud && (
                                        <th
                                            ...
                                            colSpan={1}
                                            //old sort
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            // onClick={() => handleSortIntradayDashboard("plan_.total_entry_east.value", sortState, setSortState, setSortedData, tableData)}
                                            onClick={() => handleSortIntradayDashboard("actual_.total_entry_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                    ...
                                    {columnVisibility.west_total_entry_mmbtud && (
                                        <th
                                            ...
                                            onClick={() => handleSortIntradayDashboard("actual_.total_entry_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                    ...
                                    {columnVisibility.east_west_total_entry_mmbtud && (
                                        <th
                                            ...
                                            onClick={() => handleSortIntradayDashboard("actual_.total_entry_east-west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                ...
                                {columnVisibility.exit_mmbtu && (<>
                                    {columnVisibility.east_total_exit_mmbtu && (
                                        <th
                                            ...
                                            onClick={() => handleSortIntradayDashboard("actual_.total_exit_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                    ...
                                    {columnVisibility.west_total_exit_mmbtu && (
                                        <th
                                            ...
                                            onClick={() => handleSortIntradayDashboard("actual_.total_exit_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                    ...
                                    {columnVisibility.east_west_total_exit_mmbtu && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.total_exit_east-west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                ...
                                {columnVisibility.balancing_gas && (<>
                                    {columnVisibility.east_total_balancing_gas && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.revserveBal_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                    ...
                                    {columnVisibility.west_total_balancing_gas && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.revserveBal_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                    ...
                                    {columnVisibility.east_west_total_balancing_gas && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.revserveBal_east-west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                ...
                                {columnVisibility.park_unpark && (<>
                                    {columnVisibility.east_total_park_unpark && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.park/unpark_east", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                    ...
                                    {columnVisibility.west_total_park_unpark && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.park/unpark_west", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                ...
                                {columnVisibility.ra6 && (<>
                                    {columnVisibility.ra6_ratio && (
                                        <th
                                            ...
                                            scope="col"
                                            colSpan={1}
                                            onClick={() => handleSortIntradayDashboard("actual_.detail_entry_east-west_ra6Ratio.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        >
                                            {`Ratio East`}
                                ...
                                {columnVisibility.bvw10 && (<>
                                    {columnVisibility.bvw10_ratio && (
                                        <th
                                            ...
                                            scope="col"
                                            colSpan={1}
                                            onClick={() => handleSortIntradayDashboard("actual_.detail_entry_east-west_bvw10Ratio.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        >
                                            {`Ratio East`}
                                ...
                                {columnVisibility.shrinkage_gas_and_other && (<>
                                    {columnVisibility.east_total_shrinkage_gas_and_other && (
                                        <th
                                            ...
                                            scope="col"
                                            colSpan={1}
                                            onClick={() => handleSortIntradayDashboard("actual_.shrinkage_others_east", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        >
                                            {`East`}
                                    ...
                                    {columnVisibility.west_total_shrinkage_gas_and_other && (
                                        <th
                                            ...
                                            scope="col"
                                            colSpan={1}
                                            onClick={() => handleSortIntradayDashboard("actual_.shrinkage_others_west", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        >
                                            {`West`}
                                    ...
                                    {columnVisibility.east_west_total_shrinkage_gas_and_other && (
                                        <th
                                            ...
                                            scope="col"
                                            colSpan={1}
                                            onClick={() => handleSortIntradayDashboard("actual_.shrinkage_others_east-west", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        >
                                            {`East-West`}
                                ...
                                {columnVisibility.change_min_inventory && (<>
                                    {columnVisibility.east_total_change_min_inventory && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.minInventoryChange_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                    ...
                                    {columnVisibility.west_total_change_min_inventory && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.minInventoryChange_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                    ...
                                    {columnVisibility.east_west_total_change_min_inventory && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.minInventoryChange_east-west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                ...
                                {columnVisibility.imbalance && (<>
                                    {columnVisibility.east_total_imbalance && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.dailyImb_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                    ...
                                    {columnVisibility.west_total_imbalance && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.dailyImb_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                ...
                                {columnVisibility.acc_imbalance_meter_mmbtu && (<>
                                    {columnVisibility.east_total_acc_imbalance_meter_mmbtu && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.accImb_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                    ...
                                    {columnVisibility.west_total_acc_imbalance_meter_mmbtu && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.accImb_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                ...
                                {columnVisibility.acc_imbalance_inventory_mmbtu && (<>
                                    {columnVisibility.east_total_acc_imbalance_inventory_mmbtu && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.accImbInv_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        ...
                                        >
                                            {`East`}
                                            {getArrowIcon("actual_.accImbInv_east.value")}
                                        </th>
                                    )}
                                    ...
                                    {columnVisibility.west_total_acc_imbalance_inventory_mmbtu && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.accImbInv_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        ...
                                        >
                                            {`West`}
                                            {getArrowIcon("actual_.accImbInv_west.value")}
                                        </th>
                                    )}
                                </>
                                )}
                                ...
                                {columnVisibility.system_level_east && (<>
                                    {columnVisibility.level_system_level_east && (
                                        <th
                                            ...
                                            scope="col"
                                            colSpan={1}
                                            onClick={() => handleSortIntradayDashboard("actual_.system_level_east", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        >
                                            {`Level`}
                                    ...
                                    {columnVisibility.percent_system_level_east && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.level_percentage_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                ...
                                {columnVisibility.order_east && (<>
                                    {columnVisibility.order_east_mmbtu && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.energyAdjustIFOFO_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                    ...
                                    {columnVisibility.order_east_mmscf && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.volumeAdjustIFOFO_east.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                ...
                                {columnVisibility.system_level_west && (<>
                                    {columnVisibility.level_system_level_west && (
                                        <th
                                            ...
                                            colSpan={1}
                                            onClick={() => handleSortIntradayDashboard(
                                                "actual_.system_level_west", sortState, setSortState, setSortedData, tableData
                                            )} // actual_ https://app.clickup.com/t/86eujrgb3
                                        >
                                            {`Level`}
                                    ...
                                    {columnVisibility.percent_system_level_west && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.level_percentage_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                ...
                                {columnVisibility.order_west && (<>
                                    {columnVisibility.order_west_mmbtu && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.energyAdjustIFOFO_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                    ...
                                    {columnVisibility.order_west_mmscf && (
                                        <th
                                            ...
                                            colSpan={1}
                                            // 2026-02-12 ที่มาใช้ของเก่าเพราะ --> (อ่านคอมเม้นนะ) R1 : Sorting ยังไม่ได้บาง Column เช็คทุก Column https://app.clickup.com/t/86eujrgb3 
                                            onClick={() => handleSortIntradayDashboard("actual_.volumeAdjustIFOFO_west.value", sortState, setSortState, setSortedData, tableData)} // actual_ https://app.clickup.com/t/86eujrgb3
                                        // onClick={() => handleSortIntradayDashboardModify(
                                ...
                                <>
                                    ...
                                    {row?.plan_ ?
                                        ...
                                        >
                                            ...
                                            {columnVisibility?.system_level_east && columnVisibility?.level_system_level_east && (
                                                <td
                                                    className={`px-2 py-1 text-[#464255] text-center ${isLastVisible(
                                                        columnVisibility?.level_system_level_east,
                                                        [columnVisibility?.percent_system_level_east]
                                                    ) ? 'border-r border-gray-300' : ''}`}
                                                >
                                            ...
                                            {columnVisibility?.order_west && columnVisibility?.order_west_mmscf && (
                                                ...
                                                >
                                                    ...
                                                    {formatNumberSixDecimalNom(row?.plan_?.volumeAdjustIFOFO_west?.value)}
                                                </td>
                                            )}
                                    ...
                                    {row?.actual_ ?
                                        ...
                                        >
                                            ...
                                            {columnVisibility?.ra6 && columnVisibility?.ra6_ratio && (
                                                <td
                                                    className={`px-2 py-1 text-[#464255] text-right bg-[#EAF5F9] border-r border-gray-300`}
                                                >
                                            ...
                                            {columnVisibility?.acc_imbalance_meter_mmbtu && columnVisibility?.east_total_acc_imbalance_meter_mmbtu && (
                                                <td
                                                    className={`px-2 py-1 text-[#464255] text-right ${getValidationColorClass(row?.actual_?.accImb_east?.validation?.toLowerCase())} ${isLastVisible(
                                                        columnVisibility?.east_total_acc_imbalance_meter_mmbtu,
                                                        [columnVisibility?.west_total_acc_imbalance_meter_mmbtu]
                                                    ) ? 'border-r border-gray-300' : ''}`}
                                                >
                                            ...
                                            {columnVisibility?.acc_imbalance_meter_mmbtu && columnVisibility?.west_total_acc_imbalance_meter_mmbtu && (
                                                <td
                                                    className={`px-2 py-1 text-[#464255] text-right ${getValidationColorClass(row?.actual_?.accImb_west?.validation?.toLowerCase())} ${isLastVisible(
                                                        columnVisibility?.west_total_acc_imbalance_meter_mmbtu,
                                                        []
                                                    ) ? 'border-r border-gray-300' : ''}`}
                                                >
                                            ...
                                            {columnVisibility?.acc_imbalance_inventory_mmbtu && columnVisibility?.east_total_acc_imbalance_inventory_mmbtu && (
                                                <td
                                                    className={`px-2 py-1 text-[#464255] text-right ${getValidationColorClass(row?.actual_?.accImbInv_east?.validation?.toLowerCase())} ${isLastVisible(
                                                        columnVisibility?.east_total_acc_imbalance_inventory_mmbtu,
                                                        [columnVisibility?.west_total_acc_imbalance_inventory_mmbtu]
                                                    ) ? 'border-r border-gray-300' : ''}`}
                                                >
                                            ...
                                            {columnVisibility?.acc_imbalance_inventory_mmbtu && columnVisibility?.west_total_acc_imbalance_inventory_mmbtu && (
                                                <td
                                                    className={`px-2 py-1 text-[#464255] text-right ${getValidationColorClass(row?.actual_?.accImbInv_west?.validation?.toLowerCase())} ${isLastVisible(
                                                        columnVisibility?.west_total_acc_imbalance_inventory_mmbtu,
                                                        []
                                                    ) ? 'border-r border-gray-300' : ''}`}
                                                >
                                            ...
                                            {columnVisibility?.total_imbalance && (
                                                <td
                                                    className={`px-2 py-1 text-[#464255] text-right border-r border-gray-300 ${getValidationColorClass(row?.actual_?.dailyImb_total?.validation?.toLowerCase())}`}
                                                >
                                            ...
                                            {columnVisibility?.percent_total_imbalance && (
                                                <td
                                                    className={`px-2 py-1 text-[#464255] text-right border-r border-gray-300 ${getValidationColorClass(row?.actual_?.absimb?.validation?.toLowerCase())}`}
                                                >
                                                    ...
                                                    {/* test |{JSON.stringify(row?.actual_?.absimb?.value)} */}
                                                </td>
                                            )}
                                            ...
                                            {columnVisibility?.order_east && columnVisibility?.order_east_mmbtu && (
                                                <td
                                                    ...
                                                    className={`px-2 py-1 text-[#464255] text-right ${validateOrderEastWest(row?.actual_?.accImb_east?.validation, row?.actual_?.accImbInv_east?.validation, row?.actual_?.system_level_east)} ${isLastVisible(
                                                        columnVisibility?.order_east_mmbtu,
                                                        [columnVisibility?.order_east_mmscf]
                                                    ) ? 'border-r border-gray-300' : ''}`}>
                                            ...
                                            {columnVisibility?.order_east && columnVisibility?.order_east_mmscf && (
                                                ...
                                                >
                                                    ...
                                                    {row?.actual_?.volumeAdjustIFOFO_east !== null && row?.actual_?.volumeAdjustIFOFO_east !== undefined ? formatNumberSixDecimalNom(row?.actual_?.volumeAdjustIFOFO_east?.value) : ''}
                                                </td>
                                            )}
                                            ...
                                            {columnVisibility?.order_west && columnVisibility?.order_west_mmscf && (
                                                ...
                                                >
                                                    ...
                                                    {row?.actual_?.volumeAdjustIFOFO_west !== null && row?.actual_?.volumeAdjustIFOFO_west !== undefined ? formatNumberSixDecimalNom(row?.actual_?.volumeAdjustIFOFO_west?.value) : ''}
                                                </td>
                                            )}
