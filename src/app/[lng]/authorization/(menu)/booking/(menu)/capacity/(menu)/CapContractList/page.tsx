...
const ClientPage: React.FC<ClientProps> = (props) => {
    ...
    const [dataContractDetail, setDataContractDetail] = useState<any>([]);
    ...
    const columns = useMemo<ColumnDef<any>[]>(
        () => [
            {
                accessorKey: "status",
                header: "Contract Status", // ---> ต้องเอาไปใช้ที่อื่นด้วย แต่อยากจัดกลาง
                // header: () => (
    ...
    const renderPermission: any = () => {
        ...
        try {
            ...
            permission = findRoleConfigByMenuName('Capacity Contract List', userDT)
