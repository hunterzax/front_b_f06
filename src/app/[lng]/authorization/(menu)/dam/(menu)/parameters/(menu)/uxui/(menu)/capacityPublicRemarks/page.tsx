...
import { fillMissingUpdateByAccount, filterStartEndDate, filterStartEndDateNewLogic, findRoleConfigByMenuName, formatDate, formatDateNoTime, formatSearchDate, formatTime, generateUserPermission, isISOString } from "@/utils/generalFormatter";
...
import { RemarkCell } from "@/components/other/remarkCol";
...
const ClientPage: React.FC<ClientProps> = (props) => {
            ...
            },
            {
                ...
                cell: (info) => {
                    ...
                    return (
                        ...
                        //     {row?.remark || ''}
                        // </div>
                        <div className="min-w-[360px] max-w-[720px]">
                            <RemarkCell text={row?.remark} />
                        </div>
                    )
                }
            },
    ...
    const renderPermission: any = () => {
        ...
        try {
            ...
            permission = findRoleConfigByMenuName('Capacity Publication Remark', userDT)
        } catch (error) {
            // Failed to parse user_permission:
        }
        return permission
