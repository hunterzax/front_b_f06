...
const TableEntryComposition: React.FC<any> = ({ tableData, isLoading, userPermission, zoneMaster, dataMasterZone, nominationPointMaster }) => {
                                ...
                                paginatedData && paginatedData?.map((row: any, index: any) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {columnVisibility.ic5 && (
                                                <td className={`px-2 py-1 min-w-[120px] text-right text-[#464255]`}>{row?.["8"] ? formatNumberThreeDecimal(row?.["8"]) : ''}</td>
                                            )}
