...
import { decorateRowsWithGroupSums, formatNumberThreeDecimal, formatNumberThreeDecimalNoComma, formatNumberThreeDecimalNom, formatNumberTwoDecimal, formatNumberTwoDecimalNom, getContrastTextColor } from '@/utils/generalFormatter';
...
const TableDailyArea: React.FC<any> = ({ checkIsAllAreaImbalance, openWarning, tableData, isLoading, userPermission, zoneText, tempData, setTempData, tempDataConcept, setTempDataConcept, areaMaster, entryExitMaster, setIsEdited, tabEntry, tabConcept, tabIndex2ndTab, activeButton, srchCheckbox }) => {
                ...
                <div className="flex items-center space-x-2 py-4 px-1">
                    ...
                    <div className="w-[100%] flex flex-wrap gap-2 justify-end">
                        <SearchInput onSearch={handleSearch} />
                        {
                            ...
                            <BtnText 
                                handleFieldCilck={()=>openWarning({type:"TableDailyArea", paginatedData, areaMaster, tabIndex2ndTab})}
