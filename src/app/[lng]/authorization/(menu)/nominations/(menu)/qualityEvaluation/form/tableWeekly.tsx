                                    ...
                                    {columnVisibility.sunday && (
                                        <td className={`px-2 py-1 text-right 
                                            ${
                                                ...
                                                (row?.parameter === "HV" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min != null &&
                                                    row?.sunday?.value < row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max != null &&
                                                    row?.sunday?.value > row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max
                                                    )
                                                )) || (row?.parameter === "WI" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min != null &&
                                                    row?.sunday?.value < row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max != null &&
                                                    row?.sunday?.value > row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max
                                                    )
                                                ))
                                                ? "text-[#ED1B24]"
                                                : "text-[#464255]"
                                        ...
                                        <td className={`px-2 py-1 text-right 
                                            ${
                                                ...
                                                (row?.parameter === "HV" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min != null &&
                                                    row?.monday?.value < row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max != null &&
                                                    row?.monday?.value > row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max
                                                    )
                                                )) || (row?.parameter === "WI" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min != null &&
                                                    row?.monday?.value < row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max != null &&
                                                    row?.monday?.value > row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max
                                                    )
                                                ))
                                                ? "text-[#ED1B24]"
                                                : "text-[#464255]"
                                        ...
                                        <td className={`px-2 py-1 text-right 
                                            ${
                                                ...
                                                (row?.parameter === "HV" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min != null &&
                                                    row?.wednesday?.value < row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max != null &&
                                                    row?.wednesday?.value > row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max
                                                    )
                                                )) || (row?.parameter === "WI" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min != null &&
                                                    row?.wednesday?.value < row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max != null &&
                                                    row?.wednesday?.value > row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max
                                                    )
                                                ))
                                                ? "text-[#ED1B24]"
                                                : "text-[#464255]"
                                        ...
                                        <td className={`px-2 py-1 text-right 
                                            ${
                                                ...
                                                (row?.parameter === "HV" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min != null &&
                                                    row?.thursday?.value < row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max != null &&
                                                    row?.thursday?.value > row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max
                                                    )
                                                )) || (row?.parameter === "WI" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min != null &&
                                                    row?.thursday?.value < row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max != null &&
                                                    row?.thursday?.value > row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max
                                                    )
                                                ))
                                                ? "text-[#ED1B24]"
                                                : "text-[#464255]"
                                        ...
                                        <td className={`px-2 py-1 text-right 
                                            ${
                                                ...
                                                (row?.parameter === "HV" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min != null &&
                                                    row?.friday?.value < row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max != null &&
                                                    row?.friday?.value > row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max
                                                    )
                                                )) || (row?.parameter === "WI" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min != null &&
                                                    row?.friday?.value < row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max != null &&
                                                    row?.friday?.value > row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max
                                                    )
                                                ))
                                                ? "text-[#ED1B24]"
                                                : "text-[#464255]"
                                        ...
                                        <td className={`px-2 py-1 text-right 
                                            ${
                                                ...
                                                (row?.parameter === "HV" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min != null &&
                                                    row?.saturday?.value < row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max != null &&
                                                    row?.saturday?.value > row?.zone?.zone_master_quality?.[0]?.v2_sat_heating_value_max
                                                    )
                                                )) || (row?.parameter === "WI" && (
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min != null &&
                                                    row?.saturday?.value < row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_min
                                                    ) ||
                                                    (
                                                    row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max != null &&
                                                    row?.saturday?.value > row?.zone?.zone_master_quality?.[0]?.v2_wobbe_index_max
                                                    )
                                                ))
                                                ? "text-[#ED1B24]"
                                                : "text-[#464255]"
